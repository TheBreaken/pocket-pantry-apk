...
import com.example.pocketpantry.feature.pantry.ui.BarcodeScannerScreen
...
fun pantryEntryProvider(backStack: NavBackStack<NavKey>, contentPadding: PaddingValues) =
    entryProvider {
        entry<PantryList> {
            PantryScreen(
        ...
        entry<BarcodeScanner> {
            BarcodeScannerScreen({ barcode -> Log.d("BARCODE", barcode) })
        }
    }
